...
if (str_starts_with($uri, '/api/')) {
    ...
    if ($apiPath === '/orders/razorpay-create')       { require __DIR__ . '/api/orders/razorpay-create.php'; exit; }
    if ($apiPath === '/orders/razorpay-verify')       { require __DIR__ . '/api/orders/razorpay-verify.php'; exit; }
    if (preg_match('#^/orders/(\d+)/cancel$#', $apiPath, $m)) {
        $_GET['id'] = $m[1]; require __DIR__ . '/api/orders/cancel.php'; exit;
    }
    ...
    // Image upload
    if ($apiPath === '/upload/image')           { require __DIR__ . '/api/upload/image.php'; exit; }
