<?php
$pageTitle = 'Buy Electronics Components Online | TT Electro Store – Amravati';
$pageDesc  = 'TT Electro Store – India\'s trusted online electronics components store. Shop Arduino, Raspberry Pi, ESP32, sensors, microcontrollers, DIY kits & 3D printing services. Based in Amravati, Maharashtra. Fast delivery across India.';
    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-8">
      <div class="flex items-center gap-4">
        ...
        <div class="flex gap-2">
          <div class="text-center" x-show="parseInt(days) > 0">
            <div class="countdown-digit" x-text="days"></div>
            <div class="text-[9px] font-bold tracking-widest text-slate-400 dark:text-slate-500 mt-1">DAYS</div>
          </div>
          <div class="text-center">
            <div class="countdown-digit" x-text="hours"></div>
            <div class="text-[9px] font-bold tracking-widest text-slate-400 dark:text-slate-500 mt-1">HRS</div>
          </div>
          <div class="text-center">
            <div class="countdown-digit" x-text="minutes"></div>
            <div class="text-[9px] font-bold tracking-widest text-slate-400 dark:text-slate-500 mt-1">MIN</div>
          </div>
          <div class="text-center">
            <div class="countdown-digit" x-text="seconds"></div>
            <div class="text-[9px] font-bold tracking-widest text-slate-400 dark:text-slate-500 mt-1">SEC</div>
          </div>
        </div>
        <?php endif; ?>
      </div>
